 ...
 *
 * "Estoque acabando" foi adaptado pra usar a aba "Produção" (ver
 * Producao.gs: calcularProducao) — dispara quando o estoque atual não
 * cobre o resto da meta do mês em andamento, no lugar do antigo cálculo
 * de "dias restantes" do Estoque Inteligente (removido).
 */
    ...
    .map(function (linha) {
      return {
        ...
        mensagem:
          'Estoque de "' +
          linha.produto +
          '" não cobre a meta do mês — sugerido produzir mais ' +
