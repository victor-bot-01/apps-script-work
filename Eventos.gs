...
// novo sem duplicar. Datas de Dia das Mães/Pais/Black Friday calculadas
// para 2026; precisam de ajuste manual anual (é literalmente o que o
// evento "Ajustar datas móveis" lembra de fazer).
function cadastrarEventosSugeridos_() {
  ...
  const sugeridos = [
    ...
    { titulo: 'Ajustar datas móveis (Dia das Mães, Dia dos Pais, Black Friday)', dia: 1, mes: 12, emoji: '🔄' },
  ];
