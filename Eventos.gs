 ...
 * Frete Grátis, Carnaval) NÃO têm cálculo automático (nem de "2º domingo
 * do mês" nem da Páscoa) — ficam com o dia fixo do ano em que foram
 * cadastradas (decisão consciente, ver conversa). Por isso existe um
 * evento Personalizado próprio (1º de dezembro) lembrando de reajustar
 * essas datas todo ano.
 *
...
function cadastrarEventosSugeridos() {
  ...
  const sugeridos = [
    ...
    {
      titulo:
        'Ajustar datas móveis (Dia das Mães, Dia dos Pais, Black Friday, Semana do Brasil, Dia do Frete Grátis, Carnaval, 4 estações)',
      dia: 1,
      mes: 12,
      emoji: '🔄',
    },
