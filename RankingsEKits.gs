...
function calcularProducaoPorMarketplace_(linhasTop15) {
  ...
  vendas.forEach(function (venda) {
    ...
    if (!porLoja.has(venda.loja)) porLoja.set(venda.loja, { vendidoMesPassado: 0, vendidoMesAtual: 0 });
  ...
  porChave.forEach(function (porLoja, chave) {
    resultado[chave] = Array.from(porLoja.entries())
      .map(function (par) {
        return { loja: par[0], vendidoMesPassado: par[1].vendidoMesPassado, vendidoMesAtual: par[1].vendidoMesAtual };
      })
      .sort(function (a, b) {
