 ...
 * checklist de produção (☐ Produto) na quantidade sugerida pela Produção.
 *
 ...
 *
 * Como a aba Estoque agora também tem linhas de kit (coluna "Tipo", ver
 * Producao.gs), essa tabela passa a listar kits também quando eles
 * tiverem estoque cadastrado — não precisou de nenhuma mudança de código
 * pra isso, só reflete o que estiver na aba.
 */
...
// de produção por produto/kit, na mesma base que a aba Produção usa (ver
// Producao.gs: calcularProducao).
