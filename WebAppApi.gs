...
// `itens`: array de { produto, total, individual, kit }, exatamente como
// exibido na tela no momento do envio (ver enviarRelatorioEtiquetas_ em
// JavaScript.html). Não retorna nada — o cliente trata sucesso/erro via
// resolve/reject da própria chamada.
function apiEnviarRelatorioEtiquetas(destinatario, rotuloPeriodo, itens) {
  enviarRelatorioEtiquetas_(destinatario, rotuloPeriodo, itens);
}
