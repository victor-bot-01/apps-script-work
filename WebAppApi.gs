 ...
 * Eventos.gs) — nenhuma lógica de negócio nova mora aqui.
 *
...
function apiDefinirEstoqueProducao(produto, tipo, quantidade) {
  definirEstoqueProducao_(produto, tipo, quantidade);
  return calcularProducao();
}
