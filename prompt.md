...
Abas de dashboard/BI (ver lista de funcionalidades abaixo).
...
Backup automático da base antes de cada atualização; validação contra pedidos duplicados; botão de atualização manual na planilha.
...
Visual: dashboard executivo como página inicial com cards de KPI e gráficos interativos; menu lateral; paleta escura com detalhes em azul/verde/laranja; ícones; gráficos de barra/linha/pizza/heatmap/gauge; segmentadores por período/marketplace/categoria/coleção/volumetria/tipo de venda; formatação condicional para alertas/tendências/metas. Visual livre, desde que profissional e moderno.